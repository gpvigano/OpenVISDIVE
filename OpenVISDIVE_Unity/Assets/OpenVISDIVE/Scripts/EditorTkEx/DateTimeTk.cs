...
namespace EditorTkEx
{
    public class DateTimeTk
    {
        ...
        static public DateTime DrawDateTime(string label, DateTime dateTime)
        {
            ...
            bool valid = DateTime.TryParseExact(EditorGUILayout.TextField(label, dateTime.ToString(format)), format,
                CultureInfo.InvariantCulture.DateTimeFormat, DateTimeStyles.None, out newDateTime);
