...
namespace OpenVISDIVE
{
    ...
    public class VrXmlVector3
    {
        ...
        public void Set(Vector3 vec, int precision)
        {
            ...
            x = string.Format(CultureInfo.InvariantCulture, format, vec.x);
            y = string.Format(CultureInfo.InvariantCulture, format, vec.y);
            z = string.Format(CultureInfo.InvariantCulture, format, vec.z);
        }
    ...
    public class VrXmlRotationMatrix
    {
        ...
        public static void Vector3ToRow(Vector3 vec, ref string row)
        {
            ...
            row = string.Format(CultureInfo.InvariantCulture,"{0:F6} {1:F6} {2:F6}", vec.x, vec.y, vec.z);
        }
        ...
        public static Vector3 RowToVector3(string row)
        {
            ...
            vec.x = float.Parse(values[0], CultureInfo.InvariantCulture);
            vec.y = float.Parse(values[1], CultureInfo.InvariantCulture);
            vec.z = float.Parse(values[2], CultureInfo.InvariantCulture);
            return vec;
        }
    }
    ...
    public class VrXmlLocalTransform
    {
        ...
        {
            position.Set( CsConversion.VecToVecRL(unityTransform.localPosition, zUp),3);
            ...
            rotationMatrix.FromMatrix4x4(MathUtility.QuaternionToMatrix(unityTransform.localRotation));
    ...
    public class VrXmlRepresentation
    {
        ...
        [XmlElement(ElementName ="importOptions")]
        public ModelImportOptions importOptions = null;
    }
