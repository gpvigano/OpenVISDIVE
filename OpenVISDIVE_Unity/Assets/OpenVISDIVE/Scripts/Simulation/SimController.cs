...
namespace OpenVISDIVE
{
    public class SimController : MonoBehaviour
    {
        ...
        /// </summary>
        public event Action SimulationLoaded;
        /// <summary>
        ...
        /// </summary>
        public event Action SimulationPlay;
        /// <summary>
        /// Event triggered before pausing the simulation
        /// </summary>
        public event Action SimulationPause;
        /// <summary>
        /// Event triggered after the simulation has been stopped
        /// </summary>
        public event Action SimulationStop;
        /// <summary>
        /// Event triggered after the simulation time is changed
        /// </summary>
        public event Action<float> SimulationTimeChanged;
        ...
        {
            if (SimulationPlay!=null && (!simulationStarted || simulationPaused))
            {
                SimulationPlay();
            }
            if (simulationStarted)
