...
namespace OpenVISDIVE
{
    ...
    public class SimControllerUI : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            UpdateUIState();
            simController.SimulationLoaded += UpdateUIState;
            simController.SimulationUpdated += OnSimulationUpdated;
            simController.SimulationPlay += OnPlaySimulation;
            simController.SimulationPause += OnPauseSimulation;
            simController.SimulationTimeChanged += OnSimulationTimeSet;
            simController.SimulationStop += UpdateUIState;
        }
