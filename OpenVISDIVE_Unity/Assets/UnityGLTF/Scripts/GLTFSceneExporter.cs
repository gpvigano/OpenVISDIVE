...
namespace UnityGLTF
{
    public class GLTFSceneExporter
    {
        ...
        private MaterialId ExportMaterial(Material materialObj)
        {
            ...
            else if (IsUnlit(materialObj))
            {
                // TODO: [GPV] implement, test and PR
                Debug.Log("Unlit material found!");
                material.PbrMetallicRoughness = ExportUnlitTexture(materialObj);
            }
        ...
        {
            return material.shader.name == "Unlit/Texture";
        }
        ...
        private PbrMetallicRoughness ExportUnlitTexture(Material material)
        {
            var pbr = new PbrMetallicRoughness();
            ...
            //    pbr.BaseColorFactor = material.GetColor("_Color").ToNumericsColorRaw();
            //}
            pbr.BaseColorFactor = Color.white.ToNumericsColorRaw();
